<?php
class userDetailCity extends App{
	...
	function main(){
		...
		return $this->View->toString(TEMPLATE_DOMAIN_DASHBOARD .'apps/user-detail-city.html');
		
	}
	
	function cityPagingAjax(){
		$start = strip_tags($this->_p('start'));
		$limit = 10;
		$entourageEngage = $this->userDetailCityHelper->entourageEngage($start,$limit);
		
		$total = $this->userDetailCityHelper->totalEntourage();

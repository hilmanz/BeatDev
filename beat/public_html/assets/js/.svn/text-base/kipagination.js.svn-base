		...
		if(current>=3){
			...
			if(lastPage<3){
				...
				if(current != totalPage){
					...
					str+='<input type="number" name="goto" onkeyup="checkGoTo(this,'+data+',\''+fungsi+'\',\''+type+'\',\''+divPage+'\','+setPerPage+','+goToPage+');" value="'+n+'" /><a data-current="'+n+'" class="btn gotoBTN" href="#" >GO</a>';
				}
				$("#"+divPage+"").html(str);
